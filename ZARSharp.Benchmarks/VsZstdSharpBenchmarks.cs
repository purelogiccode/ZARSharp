...
/// <c>ZstdSharp.Port</c> (a C# zstd port using <c>unsafe</c>) next to ZARSharp.
/// Decode rows run both libraries over the <em>same</em> ZARSharp-produced
...
public class VsZstdSharpBenchmarks
{
    ...
    /// <summary>ZARSharp level 6 over the hetero 64 KiB block (ratio baseline).</summary>
    ...
    /// <summary>ZARSharp level 1 over the hetero 64 KiB block.</summary>
    /// <returns>The compressed frame.</returns>
    [Benchmark]
    ...
    /// <summary>ZARSharp level 6 over 64 KiB of text.</summary>
    /// <returns>The compressed frame.</returns>
    [Benchmark]
    ...
    /// <summary>ZARSharp decodes its own level-6 hetero frame.</summary>
    ...
    /// <summary>ZstdSharp decodes the identical ZARSharp-produced bytes.</summary>
